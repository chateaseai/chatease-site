...
export default function ChatDemo() {
  ...
  return (
    <div className="w-full max-w-md mx-auto rounded-2xl border border-slate-200 bg-white shadow-lg shadow-slate-900/10 p-4 md:p-5 ring-1 ring-white/60">
      <div className="text-xs font-medium text-slate-700 mb-3">Live Demo</div>
      ...
      <div
        className={[
          ...
          isBot
            ...
            : 'bg-slate-100 border border-slate-200 text-slate-900 rounded-br-sm'
        ].join(' ')}
      >
        {text}
      </div>
